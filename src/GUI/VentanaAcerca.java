...
public class VentanaAcerca extends javax.swing.JInternalFrame {
    ...
    private static VentanaAcerca miVentanaAcerca;
    
     /**
     * Creates new form VentanaAcerca
     */
    private VentanaAcerca() {
        initComponents();
    }
    
    public static VentanaAcerca getInstance()
    {
        if(miVentanaAcerca == null)
        {
            miVentanaAcerca = new VentanaAcerca();
        }
        return miVentanaAcerca;
    }
    /**
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Acerca de Fitness");

        jPanel1.setBackground(new java.awt.Color(0, 153, 102));
        jPanel1.setForeground(new java.awt.Color(0, 102, 102));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/icono.png"))); // NOI18N
        ...
        jLabel7.setText("Valeria Garro Abarca");
        ...
        jLabel9.setText("Ingeniería en Computación");

        jLabel10.setFont(new java.awt.Font("MS Reference Sans Serif", 1, 14)); // NOI18N
        jLabel10.setText("Instituto Tecnológico de Costa Rica");
